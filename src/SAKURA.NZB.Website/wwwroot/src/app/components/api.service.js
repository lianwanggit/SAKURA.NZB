System.register(["rxjs/Rx", "angular2/http", "angular2/core"], function(exports_1, context_1) {
    ...
    var http_1, core_1;
    var CUSTOMERS_ENDPOINT, BRANDS_ENDPOINT, PRODUCTS_ENDPOINT, PRODUCTS_SEARCH_ENDPOINT, PRODUCTS_BRIEF_ENDPOINT, PRODUCTS_GET_BY_BRAND_ENDPOINT, CATEGORIES_ENDPOINT, SUPPLIERS_ENDPOINT, ORDERS_ENDPOINT, ORDERS_GET_COUNT_ENDPOINT, ORDERS_SEARCH_ENDPOINT, ORDERS_STATUS_ENDPOINT, ORDER_DELIVER_ENDPOINT, ORDER_UPDATE_STATUS_ENDPOINT, ORDER_GET_LATEST_BY_PRODUCT_ENDPOINT, EXPRESS_TRACK_ENDPOINT, EXCHANGEHISTORIES_ENDPOINT, EXCHANGEHISTORIES_YEARS_ENDPOINT, EXCHANGEHISTORIES_SUMMARY_ENDPOINT, EXCHANGEHISTORIES_SEARCH_ENDPOINT, DASHBOARD_SUMMARY_ENDPOINT, DASHBOARD_SALE_YEARS_ENDPOINT, DASHBOARD_ANNUAL_SALES_ENDPOINT, DASHBOARD_TOP_SALE_PRODUCTS_ENDPOINT, DASHBOARD_TOP_SALE_BRANDS_ENDPOINT, DASHBOARD_PAST_30_DAYS_PROFIT_ENDPOINT, DASHBOARD_PAST_30_DAYS_EXCHANGE_ENDPOINT, SETTINGS_ENDPOINT, ApiService;
    return {
        setters:[
            function (_1) {},
            function (http_1_1) {
        ...
        execute: function() {
            ...
            exports_1("ORDERS_GET_COUNT_ENDPOINT", ORDERS_GET_COUNT_ENDPOINT = "api/orders/get-count");
            ...
            exports_1("EXCHANGEHISTORIES_ENDPOINT", EXCHANGEHISTORIES_ENDPOINT = "api/exchangehistories/");
            exports_1("EXCHANGEHISTORIES_YEARS_ENDPOINT", EXCHANGEHISTORIES_YEARS_ENDPOINT = "api/exchangehistories/get-years");
            exports_1("EXCHANGEHISTORIES_SUMMARY_ENDPOINT", EXCHANGEHISTORIES_SUMMARY_ENDPOINT = "api/exchangehistories/summary/");
            exports_1("EXCHANGEHISTORIES_SEARCH_ENDPOINT", EXCHANGEHISTORIES_SEARCH_ENDPOINT = "api/exchangehistories/search/");
            exports_1("DASHBOARD_SUMMARY_ENDPOINT", DASHBOARD_SUMMARY_ENDPOINT = "api/dashboard/summary/");
            exports_1("DASHBOARD_SALE_YEARS_ENDPOINT", DASHBOARD_SALE_YEARS_ENDPOINT = "api/dashboard/sale-years/");
            ...
            exports_1("SETTINGS_ENDPOINT", SETTINGS_ENDPOINT = "api/settings/");
            ApiService = (function () {
