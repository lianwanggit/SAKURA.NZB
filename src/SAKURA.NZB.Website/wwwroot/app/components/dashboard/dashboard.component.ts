...
import {OrderDict} from "../orders/order-dict";
...
export class DashboardComponent implements OnInit {
	...
	orderStates = (new OrderDict()).orderStates;
	...
	private topSaleProductsChartData: any[] = []
	private topSaleProductsChartNames: any[] = [];
	...
	private topSaleBrandsChartLabels: any[] = [];
	private topSaleBrandsChartData: any[]  = [];
	...
	private topSaleBrandsChartCustomLegend: any[] = [];
