...
var order_dict_1 = require("../orders/order-dict");
...
var DashboardComponent = (function () {
    function DashboardComponent(http) {
        ...
        this.orderStates = (new order_dict_1.OrderDict()).orderStates;
